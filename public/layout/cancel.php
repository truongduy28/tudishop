...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container-link">
            ...
            <div class="detail">
                <?php
                $sql = "SELECT * from taikhoan, donhang WHERE taikhoan.id_taikhoan = donhang.id_taikhoan_fk &&  taikhoan.token ='$s_token' && donhang.trangthai = 4 ORDER BY donhang.ngaycapnhat DESC";
                $donhuy = executeResult($sql);
                if ($donhuy != null) {
                    foreach ($donhuy as $data) {
                        echo '
                    ...
                    echo ' <p style="text-align: center; margin: 150px;">Không có đơn hàng nào đã hủy!</p> ';
                }
                ?>
