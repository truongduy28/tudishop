      ...
      ?>
        <div class="container-link">
          ...
          ?>
            <div class="detail">
                <?php
                $sql = "SELECT * from taikhoan, donhang WHERE taikhoan.id_taikhoan = donhang.id_taikhoan_fk && taikhoan.token ='$s_token' && donhang.trangthai = 2 ORDER BY donhang.ngaycapnhat DESC";
                $danggiao = executeResult($sql);
                if ($danggiao != null) {
                    foreach ($danggiao as $data) {
                        echo '
                    ...
                    echo ' <p style="text-align: center; margin: 150px;">Không có đơn hàng nào đang giao!</p> ';
                }
                ?>
