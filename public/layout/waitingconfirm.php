...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container-link">
            ...
            <div class="detail">
                <?php
                $sql = "SELECT * from taikhoan, donhang WHERE taikhoan.id_taikhoan = donhang.id_taikhoan_fk && taikhoan.token ='$s_token' && donhang.trangthai = 1 ORDER BY donhang.ngaycapnhat DESC";
                $choxacnhan = executeResult($sql);
                if ($choxacnhan != null) {
                    foreach ($choxacnhan as $data) {
                        echo '
                    ...
                    echo ' <p style="text-align: center; margin: 150px;">Không có đơn hàng nào chờ xác nhận!</p> ';
                }
                ?>
